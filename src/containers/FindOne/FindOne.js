					...
					<div className="row">
						<div className="form-group col-md-6 col-xs-12">
							...
							<div className="form-group">
								...
								<input type="text" className="form-control" onChange={this.onChange} id="firstDate" placeholder="YYYY-MM-DD" />
								<small id="emailHelp" className="form-text text-muted">For data from all time, leave the dates empty</small>
							</div>
							<div className="form-group">
								<label>Second Date</label>
								<input type="text" className="form-control" onChange={this.onChange} id="secondDate" placeholder="YYYY-MM-DD" />
							</div>
